            ...
            >
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-slate-600 dark:text-gray-400 mt-1">{item.product.category}</p>
        ...
        <div className="space-y-4 animate-slideIn">
          <Card className="animate-scaleIn">
            ...
            <div className="space-y-3">
              ...
              {shipping === 0 && (
                <div className="flex items-center text-sm text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-900/20 p-2 rounded-lg animate-pulse">
