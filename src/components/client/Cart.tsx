  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-slate-600">{state.cart.length} item{state.cart.length !== 1 ? 's' : ''} in your cart</p>
      </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-3">
                  <button
                    ...
                    className="p-1 border border-slate-300 rounded hover:bg-slate-50 transition-all duration-200 hover:scale-110"
                  >
                ...
                <div className="text-right">
                  ...
                  <button
                    ...
                    className="text-red-600 hover:text-red-700 transition-all duration-200 hover:scale-110 mt-2"
                  >
        ...
        <div className="space-y-4 animate-slideIn">
          <Card className="animate-scaleIn">
            ...
            <div className="space-y-3">
              ...
              {shipping === 0 && (
                <div className="flex items-center text-sm text-green-600 bg-green-50 p-2 rounded-lg animate-pulse">
          ...
          {/* Promo Code */}
          <Card className="animate-scaleIn">
            <h4 className="font-medium text-slate-900 mb-3">Promo Code</h4>
